...
// Usage examples:
// hsl := srgb_to_hsl(RGB{f32(picked_color.r) / 255, f32(picked_color.g) / 255, f32(picked_color.b) / 255})
srgb_to_hsl :: proc(rgb: RGB) -> HSL {
    r := rgb.r
    g := rgb.g
    b := rgb.b
    ...
    if c_max == c_min {
        ...
        s = delta / (2.0 - c_max - c_min) if l > 0.5 else delta / (c_max + c_min)
