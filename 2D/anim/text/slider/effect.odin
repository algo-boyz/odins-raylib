...
init_animation_manager :: proc(font: rl.Font, gradient: GradientConfig = SUNSET_GRADIENT) -> AnimationManager {
...
destroy_animation_manager :: proc(manager: ^AnimationManager) {
    delete(manager.animations)
}

// Add animation to manager
add_animation :: proc(manager: ^AnimationManager, config: TextAnimationConfig) {
...
update_animations :: proc(manager: ^AnimationManager, dt: f32) {
...
reset_animations :: proc(manager: ^AnimationManager) {
...
render_animations :: proc(manager: ^AnimationManager, WIDTH: i32) {
    for &animation in manager.animations {
...
create_slide_animation :: proc(text: string, target_x, y, font_size: f32, 
...
all_animations_complete :: proc(manager: ^AnimationManager) -> bool {
    for animation in manager.animations {
...
get_animation :: proc(manager: ^AnimationManager, index: int) -> ^TextAnimation {
